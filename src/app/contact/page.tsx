    ...
    >
      ...
      <div className="flex flex-col gap-4 text-secondary-foreground">
        <span>
          ...
          project, I&apos;m here to help you bring it to life using React. Tell
      ...
      <form onSubmit={handleSubmit} className="space-y-4 lg:w-2xl">
        ...
        <div className="flex flex-wrap gap-4">
          <label className="block flex-1">
            ...
            <input
              ...
              required
              className="w-full border-[1.5px] border-secondary-foreground px-2 py-1 rounded-md text-secondary-foreground mt-2 bg-background"
            />
          </label>
          <label className="block flex-1">
            <span className="text-accent-foreground !font-mono">Last Name</span>
            <input
              type="text"
              value={form.lastName}
              onChange={(e) =>
        ...
        <label className="block">
          <span className="text-accent-foreground !font-mono">Your Email</span>
          <input
            type="email"
            value={form.from}
